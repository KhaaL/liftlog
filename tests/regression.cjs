...
(async () => {
  ...
  try {
    ...
    const result = await page.evaluate(async () => {
      ...
      t.pairRoutineItem(0, t.ui.routineDraft.items[1].id);
    ...
    await page.getByLabel('Either-of partner for Back Squat', {exact:true}).selectOption('');
    await page.getByLabel('Either-of partner for Back Squat', {exact:true}).selectOption({label:'Leg Press'});
